...
from .models import Empresa, Stock, UserProfile, DetallePedido
from .forms import FormularioEmpleado, FormularioCliente, FormularioStock, FormularioLogin, FormularioCompra
...
class ComprarListView(ListView):
    model = DetallePedido
    template_name ='detallepedido_list.html'